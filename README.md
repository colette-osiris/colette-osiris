...
I'm a senior at the University of Maryland finishing a self-designed B.S. in Bioinformatics and Computational Biology. My academic career has centered on pursuing questions that fascinate me and learning the tools necessary to answer them along the way — an approach that grew out of my own experiences navigating interdisciplinary research.
...
- **AOSC coursework** — Atmospheric and oceanic data analysis from AOSC247 (Scientific Programming) and AOSC652 (Analysis Methods), including work with NetCDF, HDF, and Cartopy on observational datasets.
- **Bridging the Skill Gap** — Workshop proposal for the CBMG Department's Community Engagement Committee on the bioinformatics-skills gap in undergraduate life science education, covering HPC and SSH, workflow systems, and Git/GitHub for version control and reproducibility.
